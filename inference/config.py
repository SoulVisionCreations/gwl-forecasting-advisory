...
class InferenceConfig:
    ...
    gwl_source: str = "nwdp"                       # GWL lookback source: "nwdp" (default) | "wris".
    #                                                Default is NWDP telemetry: the India-WRIS API is
    #                                                unreliable (recurring outages); NWDP CKAN is reachable
    #                                                and fresher. Normals read from the CSV snapshot.

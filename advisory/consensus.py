...
freshness, gated by a minimum well count. See docs/confidence_measure_design.txt.
...
# 'nearest well too far' case is handled upstream by the advisory's >15 km decline.
